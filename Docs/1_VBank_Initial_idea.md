...
- Платформа MVP: Backend (Java) + PostgreSQL + REST API `/api/v1/*` + JavaFX-клиент к API
- Выходные интерфейсы: REST API, JavaFX-клиент
...
## 11. UI JavaFX-клиент (MVP)

UI-клиент к REST API. Функции:
    - авторизация,
